...
function normalize(row, creator) {
  ...
  // Boards mark long-form explicitly ("LONG FORM"); everything else ("Other", blank,
  // or a reel) is short-form, so default to Short Form rather than leaving it unlabelled.
